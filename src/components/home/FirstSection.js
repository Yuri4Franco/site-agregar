    ...
    return (
        <>
            <div className="first-section-container">
                ...
                <div id="bg1" className="first-section-container-text-h2">
                ...
                <div id="bg2" className="first-section-container-text-h2">
                ...
                <div id="bg3" className="first-section-container-text-h2">
                    <h2 className="h2-subtitutlo"> Sensibilização </h2>
